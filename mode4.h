...
#define FRONTBUFFER ((volatile unsigned short*) 0x6000000) // Beginning of front buffer
#define BACKBUFFER  ((volatile unsigned short*) 0x600A000) // Beginning of back buffer
